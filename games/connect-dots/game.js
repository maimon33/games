...
const LEVELS = [
  {size:5, dots:[[0,0,0,4],[1,4,1,0],[2,0,4,4]]},           // 5×5, 3 colors
  {size:5, dots:[[0,0,1,3],[1,2,3,3],[3,2,4,4]]},           // 5×5, 3 colors
  {size:5, dots:[[0,0,0,3],[0,4,1,2],[1,1,3,3],[3,2,4,4]]}, // 5×5, 4 colors
  {size:5, dots:[[0,0,0,4],[1,4,1,1],[1,0,2,2],[2,3,4,4]]}, // 5×5, 4 colors
  {size:5, dots:[[0,0,0,3],[0,4,1,2],[1,1,2,3],[2,4,3,2],[3,1,4,4]]}, // 5×5, 5 colors
  {size:6, dots:[[0,0,0,4],[0,5,1,2],[1,1,2,3],[2,4,3,2],[3,1,5,0]]}, // 6×6, 5 colors
  {size:6, dots:[[0,0,0,5],[1,5,1,1],[1,0,2,3],[2,4,3,2],[3,1,5,0]]}, // 6×6, 5 colors
  {size:6, dots:[[0,0,0,4],[0,5,1,2],[1,1,2,3],[2,4,3,2],[3,1,4,3],[4,4,5,0]]}, // 6×6, 6 colors
  {size:7, dots:[[0,0,0,5],[0,6,1,2],[1,1,2,3],[2,4,3,2],[3,1,4,3],[4,4,6,6]]}, // 7×7, 6 colors
  {size:7, dots:[[0,0,0,6],[1,6,1,1],[1,0,2,4],[2,5,3,3],[3,2,4,4],[4,5,6,6]]}, // 7×7, 6 colors
  {size:7, dots:[[0,0,0,4],[0,5,1,3],[1,2,2,4],[2,5,3,3],[3,2,4,4],[4,5,5,3],[5,2,6,6]]}, // 7×7, 7 colors
  // 8×8 levels — snake-path verified, all 64 cells covered
  {size:8, dots:[[0,0,1,6],[1,5,2,1],[2,2,3,6],[3,5,4,1],[4,2,5,6],[5,5,6,1],[6,2,7,6],[7,5,7,0]]}, // 8×8, 8 colors, offset-2 pattern
  {size:8, dots:[[0,0,1,4],[1,3,2,5],[2,6,4,0],[4,1,5,4],[5,3,6,5],[6,6,7,0]]},                    // 8×8, 6 colors
  {size:8, dots:[[0,0,0,7],[1,7,1,0],[2,0,2,7],[3,7,3,0],[4,0,4,7],[5,7,5,0],[6,0,7,0]]},          // 8×8, 7 colors, last path covers bottom 2 rows
  // 9×9 levels — snake-path verified, all 81 cells covered
  {size:9, dots:[[0,0,1,2],[1,1,3,8],[3,7,4,4],[4,5,5,1],[5,0,7,7],[7,6,8,2],[8,3,8,8]]},          // 9×9, 7 colors
  {size:9, dots:[[0,0,0,8],[1,8,1,0],[2,0,2,8],[3,8,3,0],[4,0,4,8],[5,8,5,0],[6,0,6,8],[7,8,7,0],[8,0,8,8]]}, // 9×9, 9 colors (one path per row)
  {size:9, dots:[[0,0,0,8],[1,8,1,0],[2,0,3,0],[4,0,4,8],[5,8,5,0],[6,0,6,8],[7,8,7,0],[8,0,8,8]]}, // 9×9, 8 colors, center pair covers rows 2-3
];
